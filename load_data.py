...
def load_data_mnist(root, flatten=True):
...
def load_data_fmnist(root,flatten=True):
    ...
    train_data = torchvision.datasets.FashionMNIST(root=os.path.join(root,"data"), train=True, download=True, transform=transform)
    test_data = torchvision.datasets.FashionMNIST(root=os.path.join(root,"data"), train=False, download=True, transform=transform)
    return train_data.data, test_data.data
